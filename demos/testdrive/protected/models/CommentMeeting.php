...
/**
 * This is the model class for table "comment_meeting".
 *
 * The followings are the available columns in table 'comment_meeting':
 * @property integer $id
 ...
 */
class CommentMeeting extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return CommentMeeting the static model class
	 */
